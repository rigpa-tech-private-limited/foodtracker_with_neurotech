...
//	public static final String CAPTURE_DEVICE = "face_capture_device";
	...
	public static void updateClient(NBiometricClient client, Context context) {
		...
		client.setFacesTemplateSize(NTemplateSize.get(Integer.valueOf(preferences.getString(TEMPLATE_SIZE, String.valueOf(NTemplateSize.SMALL.getValue())))));
        ...
        Log.d("facecheck","CUSTOM = " + String.valueOf(NLivenessMode.CUSTOM.getValue())+" ACTIVE = "+String.valueOf(NLivenessMode.ACTIVE.getValue())+" PASSIVE = "+String.valueOf(NLivenessMode.PASSIVE.getValue())+" ACTIVE PASSIVE = "+String.valueOf(NLivenessMode.PASSIVE_AND_ACTIVE.getValue())+" SIMPLE = "+String.valueOf(NLivenessMode.SIMPLE.getValue()));
        ...
        //client.setFacesLivenessMode(NLivenessMode.get(Integer.valueOf(preferences.getString(LIVENESS_MODE, String.valueOf(NLivenessMode.CUSTOM.getValue())))));
        //client.setProperty("Faces.LivenessCustomSequence","blink");
        //client.setFacesLivenessBlinkTimeout(30000);
		//client.setProperty("Faces.LivenessCustomSequence","turnRight");
		client.setFacesLivenessThreshold((byte) preferences.getInt(LIVENESS_THRESHOLD, 0));
